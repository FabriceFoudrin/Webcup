...
<!-- Mirrored from cyboxhtml.surielementor.com/item-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 May 2022 12:19:13 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body class="header-fixed inner-page pg-item-details">
        <!-- preloade -->
    ...
    <section class="tf-section tf-item-details pb-mobie">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="image-details" data-aos="fade-right" data-aos-duration="800">
                        <img src="assets/images/common/img15.jpg" alt="">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="item-details" data-aos="fade-left" data-aos-duration="800">
                        <h5>Samuel Olukoju</h5>
                        <p class="sub">Cybox #01</p>
                        <div class="action">
                            <div class="left-box">
                                <a href="#" class="view">
                        ...
                        <p class="desc">Habitant sollicitudin faucibus cursus lectus pulvinar dolor non ultrices eget. 
                        ...
                        <div class="list-product">
                            ...
                            <div class="box corner-box">
                                <p>Face</p>
                                <h6 class="h7">One Eye</h6>
                            </div>
                            <div class="box corner-box">
                                <p>Food</p>
                                <h6 class="h7">Potato Chip</h6>
                            </div>
                            <div class="box corner-box">
                                <p>Background</p>
                                <h6 class="h7">Galaxy</h6>
                            </div>
                        </div>         
                    </div>
                </div>
    ...
    <section class="tf-section tf-project">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="tf-title m-b50" data-aos="fade-up" data-aos-duration="800">
                        <p class="h8 sub-title">NFT</p>
                        <h4 class="title m-b17">Arts & collectibles</h4>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from cyboxhtml.surielementor.com/item-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 May 2022 12:19:14 GMT -->
</html>