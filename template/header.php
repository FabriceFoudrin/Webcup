                        ...
                        <div class="col-md-12">
                            <div class="box-slider">
                                <div class="content-box">
                                    ...
                                    <div class="wrap-btn">
                                        <a href="#about" class="tf-button-st2 btn-effect"><span class="effect">Découvrir</span></a>
                                        <a href="assets/video/videosite.mp4" class="tf-button btn-effect popup-youtube">
                                            <span class="boder-fade"></span>                                     
                                            <span class="effect">Regarder la video</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="image">
