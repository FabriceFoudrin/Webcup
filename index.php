...
<<<<<<< Updated upstream
    ...
    <section class="page-title">
        <div class="swiper-container slider-main swiper-initialized swiper-horizontal swiper-pointer-events">
            <div class="swiper-wrapper" id="swiper-wrapper-2810d946ddede8d39" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                ...
                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 3" style="width: 749px;">
                ...
                <div class="swiper-slide" role="group" aria-label="3 / 3" style="width: 749px;">
            ...
            <div class="btn-next-main" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-2810d946ddede8d39" aria-disabled="false"><i class="far fa-angle-right"></i></div>
            <div class="btn-prev-main swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-2810d946ddede8d39" aria-disabled="true"><i class="far fa-angle-left"></i></div>
    ...
    <section class="tf-section tf-about pb-mobie">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="wrap-about p-l70 aos-init aos-animate" data-aos="fade-up" data-aos-duration="800">
    ...
    <section class="tf-section tf-project pb-mobie">
        <div class="container-fluid">
            <div class="swiper-container swiper mySwiper swiper-h">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="swiper mySwiper1 swiper-v swiper-initialized swiper-horizontal swiper-pointer-events swiper-free-mode">
                            <div class="swiper-wrapper" id="swiper-wrapper-2c0ab2997bd86f310" aria-live="off" style="cursor: grab; transform: translate3d(-3600px, 0px, 0px); transition-duration: 2000ms;"><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" role="group" aria-label="5 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="5" role="group" aria-label="6 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="6" role="group" aria-label="7 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="7" role="group" aria-label="8 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="0" role="group" aria-label="1 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img1.jpg" alt="">
                                        <div class="content">
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="1" role="group" aria-label="2 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="3 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="3" role="group" aria-label="4 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="4" role="group" aria-label="5 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img5.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Portals</a>
                                ...
                                <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="5" role="group" aria-label="6 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img6.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Grim Syndicate</a>
                                ...
                                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="6" role="group" aria-label="7 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img7.jpg" alt="">
                                        <div class="content">
                                           <a href="item.html">Jelly Beasts</a>
                                ...
                                <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="7" role="group" aria-label="8 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img1.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Jungle Cats</a>
                            ...
                            <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" role="group" aria-label="1 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img1.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Taiyo Robotics</a>
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="1" role="group" aria-label="2 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img2.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Pesky Penguins</a>
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img3.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Aurory</a>
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="4 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img4.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Taiyo Robotics</a>
            ...
            <div class="swiper-container swiper mySwiper swiper-h">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="swiper mySwiper2 swiper-v swiper-initialized swiper-horizontal swiper-pointer-events swiper-free-mode">
                            <div class="swiper-wrapper" id="swiper-wrapper-1c1dd25d3852cf21" aria-live="off" style="cursor: grab; transform: translate3d(-2520px, 0px, 0px); transition-duration: 2200ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="4" role="group" aria-label="5 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img3.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Portals</a>
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5" role="group" aria-label="6 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img2.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Taiyo Robotics</a>
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="6" role="group" aria-label="7 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img1.jpg" alt="">
                                        <div class="content">
                                           <a href="item.html">Pesky Penguins</a>
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="7" role="group" aria-label="8 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img5.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Aurory</a>
                                ...
                                <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="2" role="group" aria-label="3 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img5.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Jelly Beasts</a>
                                ...
                                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="3" role="group" aria-label="4 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img4.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html"> Grim Syndicate</a>
                                ...
                                <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="4" role="group" aria-label="5 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img3.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Portals</a>
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="5" role="group" aria-label="6 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img2.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Taiyo Robotics</a>
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="6" role="group" aria-label="7 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img1.jpg" alt="">
                                        <div class="content">
                                           <a href="item.html">Pesky Penguins</a>
                                ...
                                <div class="swiper-slide" data-swiper-slide-index="7" role="group" aria-label="8 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img5.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Aurory</a>
                            ...
                            <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" role="group" aria-label="1 / 8" style="width: 330px; margin-right: 30px;">
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="2" role="group" aria-label="3 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img5.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html">Jelly Beasts</a>
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="3" role="group" aria-label="4 / 8" style="width: 330px; margin-right: 30px;">
                                    <div class="img-box">
                                        <img src="assets/images/common/img4.jpg" alt="">
                                        <div class="content">
                                         <a href="item.html"> Grim Syndicate</a>
    ...
    <section class="tf-section tf-roadmap">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="tf-title m-b30 aos-init" data-aos="fade-up" data-aos-duration="800">
                ...
                <div class="col-md-12">
                    <div class="roadmap scrol">
                        <div class="box box-left">
                            <div class="rm-box style aos-init" data-aos="fade-right" data-aos-duration="1200">
                            ...
                            <div class="rm-box aos-init" data-aos="fade-right" data-aos-duration="1200">
                                <div class="corner-box">
                                    <h5>Q4 2021</h5>
                                    <ul>
                                        <li>Aenean tempor</li>
                        ...
                        <div class="box box-right">
                            <div class="rm-box style aos-init" data-aos="fade-left" data-aos-duration="1200">
                                <div class="corner-box">
                                    <h5>Q1 2022</h5>
                                    <ul>
                            ...
                            <div class="rm-box aos-init" data-aos="fade-left" data-aos-duration="1200">
                                <div class="corner-box">
                                    <h5>Q3 2021</h5>
                                    <ul>
                                        <li>Aenean tempor</li>
                            ...
                            <div class="mb-0 rm-box aos-init" data-aos="fade-left" data-aos-duration="1200">
                                <div class="corner-box">
                                    <h5>Q1 2021</h5>
                                    <ul>
                                        <li>Aenean tempor</li>
    ...
    <section class="tf-section how-we-work tablet-mb50">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12 aos-init" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12 aos-init" data-aos="fade-up" data-aos-delay="300" data-aos-duration="800">
                    <div class="box-text st2 corner-box">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12 aos-init" data-aos="fade-up" data-aos-delay="400" data-aos-duration="800">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6 col-12">
                    <div class="tf-title st2 m-b61 aos-init" data-aos="fade-up" data-aos-duration="800">
                        <p class="h8 sub-title">Our team</p>
                        <h4 class="title">Meet our TEAM</h4>
                    </div>
                    <div class="content mobie-30 aos-init" data-aos="fade-up" data-aos-duration="800">
                    ...
                    <div class="wrap-team aos-init" data-aos="fade-up" data-aos-duration="800">
                        <div class="swiper-container sl-team swiper-initialized swiper-horizontal swiper-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-969744ae21a9f02c" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                ...
                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 6" style="width: 719px; margin-right: 30px;">
                                    <div class="team-box">
                                        <div class="image">
                                            <img src="assets/images/common/team7.png" alt="">
                                        </div>
                                        <div class="content">
                                            <div class="h8"><a href="team-details.html">Devon Lane</a></div>
                                ...
                                <div class="swiper-slide" role="group" aria-label="3 / 6" style="width: 719px; margin-right: 30px;">
                                    <div class="team-box">
                                        <div class="image">
                                            <img src="assets/images/common/team8.png" alt="">
                                        </div>
                                        <div class="content">
                                            <div class="h8"><a href="team-details.html">Ralph Edwards</a></div>
                                ...
                                <div class="swiper-slide" role="group" aria-label="4 / 6" style="width: 719px; margin-right: 30px;">
                                    <div class="team-box">
                                        <div class="image">
                                ...
                                <div class="swiper-slide" role="group" aria-label="5 / 6" style="width: 719px; margin-right: 30px;">
                                    <div class="team-box">
                                        <div class="image">
                                ...
                                <div class="swiper-slide" role="group" aria-label="6 / 6" style="width: 719px; margin-right: 30px;">
                                    <div class="team-box">
                                        <div class="image">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tf-title m-b26">
                        <p class="h8 sub-title aos-init" data-aos="zoom-in" data-aos-duration="800">BLOGS</p>
                        <h4 class="title">Lastest News</h4>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="swiper-container hv2 sl-post2 swiper-initialized swiper-horizontal swiper-pointer-events aos-init" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
                        <div class="swiper-wrapper" id="swiper-wrapper-244238628c7fe495" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                            <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 4" style="width: 344.5px; margin-right: 30px;">
                            ...
                            <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 4" style="width: 344.5px; margin-right: 30px;">
                                <div class="post-item">
                            ...
                            <div class="swiper-slide" role="group" aria-label="3 / 4" style="width: 344.5px; margin-right: 30px;">
                                <div class="post-item">
                                    <div class="tag">digitalart</div>
                                    <div class="wrap">
                                        <div class="image">
                            ...
                            <div class="swiper-slide" role="group" aria-label="4 / 4" style="width: 344.5px; margin-right: 30px;">
                                <div class="post-item ">
                                    <div class="wrap">
                                        <div class="tag">digitalart</div>
                                        <div class="image">
    ...
    <section class="tf-section partner bg-st1 pb-mobie-40">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="tf-title aos-init" data-aos="fade-up" data-aos-duration="800">
                        <p class="h8 sub-title">partnerS</p>
                        <h4 class="title">CYBOX INVESTORS</h4>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="item-parner aos-init" data-aos="fade-up" data-aos-duration="800">
                        <div class="swiper-container sl-parner swiper-initialized swiper-horizontal swiper-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-5e9d62644cf2dbbe" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo1.png" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo2.png" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide" role="group" aria-label="3 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo3.png" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide" role="group" aria-label="4 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo4.png" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide" role="group" aria-label="5 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo5.png" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide" role="group" aria-label="6 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo6.png" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide" role="group" aria-label="7 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo7.png" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide" role="group" aria-label="8 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo8.png" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide" role="group" aria-label="9 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                        ...
                        <div class="swiper-container sl-parner swiper-initialized swiper-horizontal swiper-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-cb143df7a13e8598" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo7.png" alt="">
                                    </div>
                        ...
                        <div class="swiper-container sl-parner mb0 swiper-initialized swiper-horizontal swiper-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-f07f22dd15b346f5" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 9" style="width: 134.75px; margin-right: 60px;">
                                    <div class="image">
                                        <img src="assets/images/logo/logo13.png" alt="">
                                    </div>
    ...
    <section class="tf-section faq">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="tf-title m-b60 aos-init" data-aos="fade-up" data-aos-duration="800">
                        <p class="h8 sub-title">FAQs</p>
                        <h4 class="title">Looking for answers?</h4>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="flat-accordion aos-init" data-aos="fade-up" data-aos-duration="800">
                        <div class="flat-toggle box-text corner-box active">
                            <div class="h7 toggle-title active">What are the NFTs?</div>
                            <p class="toggle-content" style="display: block;">Urna vitae erat et lacus, consectetur ac nulla vestibulum lobortis. 
                        ...
                        <div class="flat-toggle box-text corner-box mobie-bt0">
