...
<!-- Mirrored from cyboxhtml.surielementor.com/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 May 2022 12:19:26 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-12">
                    <div class="content-about m-b50 mobie-40" data-aos="fade-right" data-aos-duration="800">
                    ...
                    <form action="https://cyboxhtml.surielementor.com/contact/contact-process.php" class="form-contact" id="contactform" data-aos="fade-right" data-aos-duration="800">
                        <fieldset>
                ...
                <div class="col-xl-7 col-lg-7 col-md-12">
                    <div class="contact-details p-l150" data-aos="fade-left" data-aos-duration="800">
                        <div class="adress wrap-fx">
                            <div class="location">
                                <h6>Location</h6>
                                <ul>
