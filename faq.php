...
<!-- Mirrored from cyboxhtml.surielementor.com/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 May 2022 12:19:10 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body class="header-fixed inner-page pg-faq">
        <!-- preloade -->
    ...
    <section class="tf-section faq style3 bg-st2 flat-accordion">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                    ...
                    <div class="flat-toggle box-text corner-box">
                        <div class="h7 toggle-title">How much will it cost to mint?</div>
                        <p class="toggle-content">Gravida viverra dui aliquet eu tortor lorem et gravida. Sed amet phasellus tellus mauris auctor rhoncus. 
                            Malesuada nisl at mauris cursus lorem mattis arcu.</p>
                    </div>
                    <div class="flat-toggle box-text corner-box">
                        <div class="h7 toggle-title">What's the story behind the art?</div>
                        <p class="toggle-content">Gravida viverra dui aliquet eu tortor lorem et gravida. Sed amet phasellus tellus mauris auctor rhoncus. 
                            Malesuada nisl at mauris cursus lorem mattis arcu.</p>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                    <div class="content-about p-l70 m-b50 mobie-40">
                        <div class="tf-title st2 m-b17">
                            <h4 class="title">Have a question </h4>
                        </div>
                        <p class="m-r-40">Fill up the Form  and ou team will get back to within 24 hrs</p>
                    </div>
                    <form action="https://cyboxhtml.surielementor.com/contact/contact-process.php" class="form-contact p-l70" id="contactform">
                        <fieldset>
                        ...
                        <fieldset>
                            <textarea placeholder="Type your Messege" rows="5" tabindex="4" name="message" class="message" id="message"></textarea>
                        </fieldset>
                        <button class="tf-button btn-effect" type="submit"><span class="boder-fade"></span><span class="effect">Send Message</span></button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script src="inc/js/jquery-validate.js"></script>
</body>

<!-- Mirrored from cyboxhtml.surielementor.com/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 May 2022 12:19:12 GMT -->
</html>